...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **SFE_RND_HD** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
Description : 'SFE_RND_HD estimates the risk neutral and historical Density for option data (traded
on the 22nd of December 2014) and historical index of the DAX. The RND is estimated by the Rookley
method and the historical density (HD) by kernel density estimation. The results are plots
corresponding to the expiration date of the options where the RND and HD.'

Keywords : 'kernel, Black Scholes, Breeden and Litzenberger, nonparametric, option price, density,
State-Price Density, Rookley, historical density'
...
Input : 'Historical time series of the DAX Index price, option price, strike price, risk free
interest rate, time to maturity, DAX Index price.'

Output : Densities for different times to maturity and the corrsponding plots.
