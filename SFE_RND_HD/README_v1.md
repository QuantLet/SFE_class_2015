...
Description:      'SFE_RND_HD estimates the risk neutral and historical
                  ...
                  and historical index of the DAX.
                  The RND is estimated by the Rookley method and the historical
                  density (HD) by kernel density estimation. The results
                  are plots corresponding to the expiration date of the
                  options where the RND and HD.'
